...
namespace Sohbet_Uygulaması_V3._0.UserController
{
    public partial class HesapOlusturUC : UserControl
    {
        ...
        private void CreKaUCTB_TextChanged(object sender, EventArgs e)
        {
            if (CreKaUCTB.Text.Length > 0 && CreKaUCTB.Text.Length <= 20)
            {
                pictureBox1.Image = images[CreKaUCTB.Text.Length - 1];
                pictureBox1.BackgroundImageLayout = ImageLayout.Stretch;
            }
            else if (CreKaUCTB.Text.Length <= 0)
                pictureBox1.Image = Properties.Resources.BeyazPostluAyıdefault;
            else
                pictureBox1.Image = images[22];
        }

        private void CreSifUCTB_Click(object sender, EventArgs e)
        {
        ...
        private void CreKaUCTB_Click(object sender, EventArgs e)
        {

            if (CreKaUCTB.Text.Length > 0)
                pictureBox1.Image = images[CreKaUCTB.Text.Length - 1];
            else
                pictureBox1.Image = Properties.Resources.BeyazPostluAyıdefault;
        }
